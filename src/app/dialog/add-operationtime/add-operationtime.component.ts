...
@Component({
  selector: 'app-add-operationtime',
  templateUrl: './add-operationtime.component.html',
  styleUrls: ['./add-operationtime.component.scss']
})
export class AddOperationtimeComponent implements OnInit {
  namelocal: any
  Codelocal: any
  departmentlocal: any
